...
export class AppRegister extends Construct {
  ...
  public constructor(scope: Construct, id: string, props: AppRegisterProps) {
    super(scope, id);
  ...
  private _createAppRegistry(stack: Stack): appreg.Application {
    ...
    //   organizationArns: ["arn:aws:organizations::760495673160:organization/o-71pzu8i8x3"],
